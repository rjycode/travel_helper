...
from atguigu.plan.turn_plan import TurnPlanValidatedResult, TurnPlan, ClarifyReason, TaskTurnPlan, KnowledgeTurnPlan
from atguigu.task.commands.command import StartFlowCommand, SetSlotsCommand, CancelFlowCommand, ResumedFlowCommand
from atguigu.task.flows.flows import FlowList


class TurnPlanValidator:
    """轮次规划校验器，负责校验 TurnPlan 中各轨道的合法性。"""
    def valid(self,
              turn_plan: TurnPlan,
